...
<meta charset="UTF-8">
    ...
    <title>Reservas canceladas | WeSports</title>
...
<body class="body-user">
    ...
    <div class="header-in">
        <h3 class="title-user">Canceladas</h3>
    ...
    <main class="main-tabla">
        <div id="vacio">
            ...
            <p>No tienes ninguna reserva cancelada.</p>
        </div>
        ...
        <table id="tablaReservasEstado">
            <thead>
                ...
                <div id="mensajeError" class="mensaje error reserva"></div>
                <tr>
                    <th>Polideportivo</th>
                    <th>Pista</th>
                    ...
                    <th>Hora inicio</th>
                    <th>Hora fin</th>
                    <th colspan="2">Reactivar reserva</th>
                </tr>
            </thead>
            <tbody>
